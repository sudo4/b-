            ...
            <div class="login-box card">
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                                @csrf
                                <img src="../assets/images/logo.svg" style="width: 25%; display: block; margin-left: auto; margin-right: auto;">
                                <h4 class="box-title m-b-20 text-center"><strong>Munas APJATI<br>2020</strong></h4>
